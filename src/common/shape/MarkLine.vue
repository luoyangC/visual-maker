...
export default {
  ...
  methods: {
    ...
    getNodeRelativePosition(node) {
      ...
      const nodeLeft = left - editorRectInfo.left;
      const nodeTop = top - editorRectInfo.top;
      const nodeRight = right - editorRectInfo.left;
      const nodeBottom = bottom - editorRectInfo.top;
